...
";
    ...
    protected function populateTable() {
        ...
        $queries = [
            ...
            "INSERT INTO `senior_theses` VALUES (49, 'christina_fetherolf_08.pdf', NULL, 'Christina', 'Fetherolf', NULL, 'To Marry God: The Portrayal of God as an Abusive Husband in Ezekiel', NULL, 112, 'Religion', '', 2008, 'Barbara Keiser;Warren Copeland', 'christina.fetherolf@gmail.com', 'campus', '\"To Marry God\" offers a close reading of Ezekiel 16 in its historical, social and literary context in order to understand and evaluate the depiction of God as abusive husband.  The author''s main argument is that Ezekiel''s use of the marriage metaphor cannot be understood outside of the blessings and curses of Deuteronomy.  Background on the historical situation is provided, along with a discussion of the marriage metaphor''s use within the canon.  The paper ends with an attempt to bring the issue to modern-day relevance.', NULL, 'pass', 'Y', 'Y', 'N')",
